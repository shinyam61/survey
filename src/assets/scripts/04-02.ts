...
import vShader from './shader/04-02/vertex.glsl?raw'
import fShader from './shader/04-02/fragment.glsl?raw'
...
class App {
  ...
  #render () {
...

    {
      ...
      console.log(Object.values(this.mouse))
      gl.uniform2fv(this.#renderParams.uniLocation.mouse, Object.values(this.mouse));
      gl.uniform2fv(this.#renderParams.uniLocation.resolution, Object.values(this.#resolution));
